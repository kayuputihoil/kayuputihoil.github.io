...
workbox.core.setCacheNameDetails({prefix:'workbox',suffix:'v8'})//jika ubah suffix jgn lupa ubah di suffix di event activate 
...
workbox.routing.registerRoute(
  ...
  //   cacheName: 'workbox-runtime-v8', // Nama cache untuk file CSS
  // plugins: [
    ...
    caches.keys().then(keyList => {
      return Promise.all(
        keyList.filter(key => {
          ...
          return !key.startsWith('workbox') || !key.endsWith('v8');
        }).map(key => {
            console.log(key);
